...
# --- 4. SILNIK WIZUALNY VORTEZA (FIX DLA PIONOWYCH NAPISÓW) ---
def inject_hub_theme():
    ...
    st.markdown(f"""
        <style>
            ...
            /* Fix dla napisów w menu bocznym */
...
def main_hub():
    ...
    # Inicjalizacja kluczowych zmiennych sesji
    ...
    with st.sidebar:
        ...
        if logo_side_b64:
            st.markdown(f'<p style="text-align:center; margin-bottom: 20px;"><img src="data:image/jpg;base64,{logo_side_b64}" width="220"></p>', unsafe_allow_html=True)
        else:
        ...
        # Wybór modułu - radio jest jedynym "władcą" zmiennej app_mode
    ...
    # Główne wywołania Twoich silników (IDENTYCZNIE JAK RANO)
