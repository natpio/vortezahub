...
# --- 3. DYNAMICZNY SILNIK STATYSTYK (TWOJA LOGIKA) ---
    ...
    st.markdown(f"""
        <style>
            ...
            .module-container:hover .module-card {{
                ...
                box-shadow: 0 15px 35px rgba(181, 136, 99, 0.4);
            }}
            .module-card img {{
                width: 150px;
                margin-bottom: 25px;
            ...
            /* Przezroczysty przycisk na całą kartę */
            .stButton button {{
                position: absolute;
                top: 0;
                left: 0;
